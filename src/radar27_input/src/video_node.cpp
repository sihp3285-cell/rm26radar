...
public:
    ...
    : Node("video_node", options), is_running_(false)
    {
        ...
        pause_service_=create_service<std_srvs::srv::SetBool>("/video_node/set_pause",[this](std_srvs::srv::SetBool::Request::SharedPtr q,std_srvs::srv::SetBool::Response::SharedPtr r){paused_=q->data;r->success=true;r->message=q->data?"paused":"playing";});
        // 2. 打开视频
