#include <radar27_fusion/target_fusion.hpp>
#include <iostream>
#include <limits>
#include <stdexcept>
...
int main() {
    ...
    w.calibration_version=1; check(!get().targets[1].valid,"reject previous calibration epoch");
    p.calibration_version=1;check(get().targets[1].valid,"same calibration epoch accepted");
