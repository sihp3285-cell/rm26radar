...
public:
        ...
        : Node("qt_display_node"), window_(window)
    {
        ...
        display_flip_pub_=create_publisher<std_msgs::msg::Bool>("/display_flip",rclcpp::QoS(1).reliable().transient_local());
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr display_flip_pub_;
