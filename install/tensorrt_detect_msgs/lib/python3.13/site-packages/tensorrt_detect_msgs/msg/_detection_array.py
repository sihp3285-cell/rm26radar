...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tensorrt_detect_msgs.msg import DetectionBox
            if DetectionBox.__class__._TYPE_SUPPORT is None:
                DetectionBox.__class__.__import_type_support__()
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<tensorrt_detect_msgs/DetectionBox>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tensorrt_detect_msgs', 'msg'], 'DetectionBox')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, DetectionBox) for v in value) and
                 True), \
                "The 'detections' field must be a set or sequence and each value of type 'DetectionBox'"
