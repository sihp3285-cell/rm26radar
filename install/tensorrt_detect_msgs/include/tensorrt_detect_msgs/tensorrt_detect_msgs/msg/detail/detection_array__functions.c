...
tensorrt_detect_msgs__msg__DetectionArray__init(tensorrt_detect_msgs__msg__DetectionArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    tensorrt_detect_msgs__msg__DetectionArray__fini(msg);
    return false;
  }
  // detections
  if (!tensorrt_detect_msgs__msg__DetectionBox__Sequence__init(&msg->detections, 0)) {
    tensorrt_detect_msgs__msg__DetectionArray__fini(msg);
    return false;
  }
  return true;
...
tensorrt_detect_msgs__msg__DetectionArray__fini(tensorrt_detect_msgs__msg__DetectionArray * msg)
{
  ...
  // detections
  tensorrt_detect_msgs__msg__DetectionBox__Sequence__fini(&msg->detections);
}
...
tensorrt_detect_msgs__msg__DetectionArray__are_equal(const tensorrt_detect_msgs__msg__DetectionArray * lhs, const tensorrt_detect_msgs__msg__DetectionArray * rhs)
{
  ...
  // detections
  if (!tensorrt_detect_msgs__msg__DetectionBox__Sequence__are_equal(
  ...
  tensorrt_detect_msgs__msg__DetectionArray * output)
{
  ...
  // detections
  if (!tensorrt_detect_msgs__msg__DetectionBox__Sequence__copy(
...
tensorrt_detect_msgs__msg__DetectionArray__create(void)
{
  ...
  tensorrt_detect_msgs__msg__DetectionArray * msg = (tensorrt_detect_msgs__msg__DetectionArray *)allocator.allocate(sizeof(tensorrt_detect_msgs__msg__DetectionArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tensorrt_detect_msgs__msg__DetectionArray));
  bool success = tensorrt_detect_msgs__msg__DetectionArray__init(msg);
  if (!success) {
...
tensorrt_detect_msgs__msg__DetectionArray__Sequence__init(tensorrt_detect_msgs__msg__DetectionArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tensorrt_detect_msgs__msg__DetectionArray * data = NULL;

  if (size) {
    data = (tensorrt_detect_msgs__msg__DetectionArray *)allocator.zero_allocate(size, sizeof(tensorrt_detect_msgs__msg__DetectionArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tensorrt_detect_msgs__msg__DetectionArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tensorrt_detect_msgs__msg__DetectionArray__fini(&data[i - 1]);
      }
...
tensorrt_detect_msgs__msg__DetectionArray__Sequence__fini(tensorrt_detect_msgs__msg__DetectionArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tensorrt_detect_msgs__msg__DetectionArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tensorrt_detect_msgs__msg__DetectionArray__Sequence * array = (tensorrt_detect_msgs__msg__DetectionArray__Sequence *)allocator.allocate(sizeof(tensorrt_detect_msgs__msg__DetectionArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tensorrt_detect_msgs__msg__DetectionArray__Sequence__init(array, size);
  if (!success) {
...
tensorrt_detect_msgs__msg__DetectionArray__Sequence__destroy(tensorrt_detect_msgs__msg__DetectionArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tensorrt_detect_msgs__msg__DetectionArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tensorrt_detect_msgs__msg__DetectionArray__Sequence__are_equal(const tensorrt_detect_msgs__msg__DetectionArray__Sequence * lhs, const tensorrt_detect_msgs__msg__DetectionArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tensorrt_detect_msgs__msg__DetectionArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tensorrt_detect_msgs__msg__DetectionArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tensorrt_detect_msgs__msg__DetectionArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tensorrt_detect_msgs__msg__DetectionArray * data =
      (tensorrt_detect_msgs__msg__DetectionArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tensorrt_detect_msgs__msg__DetectionArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tensorrt_detect_msgs__msg__DetectionArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tensorrt_detect_msgs__msg__DetectionArray__copy(
